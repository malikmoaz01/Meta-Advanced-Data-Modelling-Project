CREATE DATABASE  IF NOT EXISTS `global_super_store` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `global_super_store`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: global_super_store
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  KEY `shipping_id_fk_idx` (`ShippingID`),
  CONSTRAINT `customer_id_fk` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `product_id_fk` FOREIGN KEY (`ProductID`) REFERENCES `products` (`ProductID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `shipping_id_fk` FOREIGN KEY (`ShippingID`) REFERENCES `shipping` (`ShippingID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shipping` (
  ...
  CONSTRAINT `address_id_fk` FOREIGN KEY (`AddressID`) REFERENCES `deliveryaddress` (`AddressID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-08 11:04:03
